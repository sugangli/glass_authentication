...
\begin{center}
\begin{tabular}{ccc}
\includegraphics [width=.32\linewidth]{figure/resp_time_cos.png}&
\includegraphics [width=.32\linewidth]{figure/resp_time_cor.png}&
\includegraphics [width=.32\linewidth]{figure/resp_time_dtw.png}\\
