...
Figure~\ref{fig:width_amp} shows each subject's wave amplitude box plot (we collected *** nodding samples for each subject in the experiment). We observe that each subject's wave amplitude distribution *** 
