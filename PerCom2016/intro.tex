...
allow linking the device to online accounts instead of a phone for
...
involving more than 60 users and over
...
acceptance rate of 4.43\% and an average true-positive rate of 95.57\%. Also, we show that when the user slightly increases her head-movement complexity, it becomes \emph{much harder} for attackers to imitate the movement pattern.
...
indicate an average response time of 1.93 seconds on the Google Glass for the
