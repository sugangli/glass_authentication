...
acceptance rate of ***\% and an average true-positive rate of ***\%. Also, we show that when the user slightly increases her head-movement complexity, it becomes \emph{much harder} for attackers to imitate the movement pattern.
...
indicate an average response time of *** seconds on the Google Glass for the
