...
6s and 10s, in order to yield a sufficient sample length. We also conducts a experiment with shorter music duration(2s and 3s), however, the accuracy drop significantly. %As we will show further, the accuracy of the system can
