...
95.57\% while keeping the average false acceptance rate of 4.43\%. We also show that, even simple head-movement patters are robust against imitation attacks. Finally, we demonstrate  our authentication algorithm is rather light-weight: the processing latency on Google Glass is as low as 1.9 seconds. 
