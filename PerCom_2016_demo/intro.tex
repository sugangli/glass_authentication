...
In the following sections we will describe the~\systemname system design briefly in Section~\ref{sec:system}, we refer the reader to our full paper~\cite{percom16full} in PerCom 2016 for more details on the system design and evaluations. Section~\ref{sec:demo }describes the implementation and demonstration plans.
